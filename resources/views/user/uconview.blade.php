        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-5" {{-- style="margin-top: 6%;" --}}>
                    <div>
                        <h4>প্রোফাইল মেন্যু </h4>
                    </div>
                    <hr>

                    <div class="list-group">
                        <a href="{{ route('user.profile') }}" class="list-group-item list-group-item-action "><i
                                class="fa fa-address-card" aria-hidden="true"></i>
                            ড্যাশবোর্ড
                        </a>
                        <a href="{{ route('user.orders') }}" class="list-group-item list-group-item-action"><i
                                class="fa fa-truck" aria-hidden="true"></i> অর্ডার তথ্য বিবরণ</a>

                        <a href="{{ route('user.consultant') }}" class="list-group-item list-group-item-action active"><i
                                class="fa fa-user-md" aria-hidden="true"></i> স্বাস্থ্য পরামর্শদাতা</a>

                        <a href="{{ route('blood.page') }}" class="list-group-item list-group-item-action">
                ...
                <div class="col-lg-9 col-md-7">
                    <div>
                        <h4 class="text-center">স্বাস্থ্য পরামর্শকগণের তথ্য বিবরণ</h4>
                    </div>
                    <hr>
                    @php
                        $consultants = App\Consultant::where('status', 0)
                            ->latest()
                            ->get();
                    @endphp
                                ...
                                <div class="card" style="width: 13rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('chatcon', $row->id . '-' . str_slug($row->name)) }}"><button
                                                type="button" class="btn btn-primary btn-sm"><i class="fa fa-envelope"></i>
                                                Message
                                            </button></a>
